...
const GuestSelector = ({ guests, onChange, onClose }) => {
  ...
  return (
    <div className="absolute top-full left-0 right-0 md:left-auto md:right-0 mt-2 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 p-6 z-[9999] w-full md:w-[400px]">
